...
src_image = cv2.imread(r'E:\DSIP\VS Py\Open7\image 2.jpeg', cv2.IMREAD_GRAYSCALE)
...
# 2. Thresholding
_,thresholded_image = cv2.threshold( src_image,100,255, cv2.THRESH_BINARY)
# 3. Gamma Correction
gamma = 2
